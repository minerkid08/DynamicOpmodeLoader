...
---@class WaitForFirstAction: Action
...
---@param ... Action
---@return WaitForFirstAction
function WaitForFirstAction.new(...)
	local a = new(WaitForFirstAction);
	a.actions = { ... };
	a.initalActions = { ... };
	a.endTimes = {};
	return a;
...
---@param et number
function WaitForFirstAction:start(et)
...
function WaitForFirstAction:error()
	for _, action in ipairs(self.actions) do
...
---@param et number
---@return ActionState
function WaitForFirstAction:update(dt, et)
	local count = 0;
...
---@param file file*
---@param indent string?
function WaitForFirstAction:genProfileStr(file, indent)
	if (indent == nil) then
